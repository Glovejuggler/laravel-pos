                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('unit.sales')" :active="route().current('unit.sales')">
                                    Unit Sales
                                </NavLink>
                                <NavLink :href="route('inventory.costing')" :active="route().current('inventory.costing')">
                                    Inventory Costing
                                </NavLink>
                            </div>
                        </div>
                                ...
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink :href="route('users.index')"
                                            v-if="$page.props.auth.user.id === 1"> Users </DropdownLink>
